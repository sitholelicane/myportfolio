...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient = "sitholelicane0@gmail.com";
     $recipient = "kelvinmunhumumwe@gmail.com"; 
    ...
    if (mail($recipient, $email_subject, $email_content, $email_headers)) {
        ...
        echo "Thank you! Your message has been sent. - contact.php:31";
    } else {
        echo "Oops! Something went wrong, and we couldn't send your message. - contact.php:33";
    }
} else {
    echo "There was a problem with your submission, please try again. - contact.php:36";
}
?>