...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient = "sitholelicane0@example.com"; 
    ...
    if (mail($recipient, $email_subject, $email_content, $email_headers)) {
        ...
        echo "Thank you! Your message has been sent. - contact.php:29";
    } else {
        echo "Oops! Something went wrong, and we couldn't send your message. - contact.php:31";
    }
} else {
    echo "There was a problem with your submission, please try again. - contact.php:34";
}
?>